    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = await _userManager.Users.FirstOrDefaultAsync(u => u.NormalizedEmail == Input.EmailOrUsername.Normalize() |
                                                         u.NormalizedUserName == Input.EmailOrUsername.Normalize());
                if (user != null)
                {
